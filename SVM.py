...
plt.show()
# ======================================================
# PHẦN 2: HUẤN LUYỆN & ĐÁNH GIÁ VỚI SVM
# ======================================================
...
# Huấn luyện SVM
svm = SVC(kernel="rbf", C=1.0, gamma="scale", random_state=42)  # có thể đổi kernel="linear"
...
plt.show()
# ======================================================
# PHẦN 3: DỰ ĐOÁN ẢNH MỚI VỚI SVM
# ======================================================
...
test_img_path = os.path.join(
    ...
    random.choice(os.listdir(os.path.join(data_dir, "test", "PNEUMONIA")))
)
print("Ảnh test:", test_img_path)
predict_image(test_img_path, svm, scaler, pca, categories)
